package SOMETH;
	...
	public class mail {
	    ...
	    public static String myEmailPassword = "123123456789";
	    ...
	    // 收件人邮箱（替换为自己知道的有效邮箱）
	    public static String receiveMailAccount = "456789@qq.com";
	    ...
	    public static void main(String[] args) throws Exception {
	       ...
	       // props.setProperty("mail.smtp.socketFactory.port", "465");            // 需要请求认证
